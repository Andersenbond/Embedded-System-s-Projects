...
void HashPartition(uint PartitionNumber)
{
    ...
    int iHashCount = 1;
    uchar* read = 0;
    u32 ImageStartAddress = *(u32 *)BASEADDR_HOLDER;
    ...
    read = (uchar*) (ImageStartAddress + (PartitionHeader[PartitionNumber].PartitionStart<<WORD_LENGTH_SHIFT) + FlashReadBaseAddress);
