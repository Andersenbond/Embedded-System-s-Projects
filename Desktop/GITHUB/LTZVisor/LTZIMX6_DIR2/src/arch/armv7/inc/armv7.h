...
void v7_arch_cp15_set_l2aux_ctrl(uint32_t l2auxctrl, uint32_t cpu_midr,
				 uint32_t cpu_rev_comb, uint32_t cpu_variant,
				 uint32_t cpu_rev);
void v7_arch_cp15_set_acr(uint32_t acr, uint32_t cpu_midr, uint32_t cpu_rev_comb,
			  uint32_t cpu_variant, uint32_t cpu_rev);
#endif /* ! __ASSEMBLY__ */
