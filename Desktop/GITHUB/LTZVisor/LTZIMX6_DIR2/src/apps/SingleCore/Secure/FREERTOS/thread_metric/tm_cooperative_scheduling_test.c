...
unsigned long   average;
    ...
    while(1)
    {
            ...
            (tm_cooperative_thread_4_counter > (average + 1)))
        {
            ...
            printk ("T0: %lu\nT1: %lu\nT2: %lu\nT3: %lu\nT4: %lu\n",tm_cooperative_thread_0_counter, tm_cooperative_thread_1_counter, tm_cooperative_thread_2_counter ,tm_cooperative_thread_3_counter, tm_cooperative_thread_4_counter );
#else
            while(1)
            {
