...
#define TZASC_ADDR_WIDTH             (0b11111<<8)
...
#define TZASC_REG1_ATTRIB_SIZE       (0b011100<<1) // SECURE REGION SIZE - 512MB (NS-3328MB)
#define TZASC_REG1_ATTRIB_SP         (0xC0000000 )  // SECURE ACCESS
#define TZASC_REG1_ATTRIB            (TZASC_REG1_ATTRIB_SP | TZASC_REG1_ATTRIB_SIZE | TZASC_REG1_ATTRIB_EN) // ALL ACCESS
