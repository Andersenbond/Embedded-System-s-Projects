...
void ccm_iomux_config(void)
{
    ...
    // Config ccm.CCM_PMIC_READY to pad GPIO17(R1)
    // HW_IOMUXC_SW_MUX_CTL_PAD_GPIO17_WR(0x00000002);
    ...
    HW_IOMUXC_SW_MUX_CTL_PAD_GPIO17_WR(
            ...
            BF_IOMUXC_SW_MUX_CTL_PAD_GPIO17_MUX_MODE_V(ALT2));
    // Pad Control Register:
    ...
    // IOMUXC_CCM_PMIC_READY_SELECT_INPUT(0x020E07F0)
