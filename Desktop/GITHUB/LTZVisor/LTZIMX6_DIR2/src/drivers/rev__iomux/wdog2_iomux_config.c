...
// Function to configure IOMUXC for wdog2 module.
void wdog2_iomux_config(void)
{
    // Config wdog2.WDOG2_B to pad DISP0_DATA09(T25)
    // HW_IOMUXC_SW_MUX_CTL_PAD_DISP0_DATA09_WR(0x00000003);
    ...
    HW_IOMUXC_SW_MUX_CTL_PAD_DISP0_DATA09_WR(
            ...
            BF_IOMUXC_SW_MUX_CTL_PAD_DISP0_DATA09_MUX_MODE_V(ALT3));
    ...
    // Config wdog2.WDOG2_RESET_B_DEB to pad SD1_DATA3(F18)
    // HW_IOMUXC_SW_MUX_CTL_PAD_SD1_DATA3_WR(0x00000006);
    ...
    HW_IOMUXC_SW_MUX_CTL_PAD_SD1_DATA3_WR(
            ...
            BF_IOMUXC_SW_MUX_CTL_PAD_SD1_DATA3_MUX_MODE_V(ALT6));
    // Pad Control Register:
