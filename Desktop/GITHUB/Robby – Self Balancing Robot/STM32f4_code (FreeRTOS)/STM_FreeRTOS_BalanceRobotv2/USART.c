...
char received_string[MAX_R_STRLEN+1]; // this will hold the recieved string
...
/*void SendPIDValues(){
	...
	snprintf(send_string, 10, "1%.2f-", kpb);
	USART_puts(USART1, send_string);
	snprintf(send_string, 10, "2%.2f-", kib);
	USART_puts(USART1, send_string);
	snprintf(send_string, 10, "3%.2f-", kdb);
	USART_puts(USART1, send_string);
	snprintf(send_string, 10, "4%.2f-", kpd);
	USART_puts(USART1, send_string);
	snprintf(send_string, 10, "5%.2f-", kid);
	USART_puts(USART1, send_string);
